...
if __name__ == '__main__':
    # file1='.\pddl1\Subtraction_game\OneValue' #运行一个文件夹 保留每个pddl的解和时间
    # listDir = os.listdir(file1)
    # for i in range(0,len(listDir)):
    #     pddlFile = os.path.join(file1,listDir[i])
    pddlFile="pddl1\Take-away\Take-away-2.pddl"
